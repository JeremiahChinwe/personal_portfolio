...
export default function About() {
  return (
    <section className="px-[1.5rem]" name="about">
        ...
        <p className="leading-[1.5rem] font-[400] text-center mx-auto block sm:w-[80%] lg:w-[50%]">I&apos;m a front-end software developer with 3years+ experience building visually appealing, mobile responsive, high-functional, maintainable, and scalable web apps with modern technologies that meets your business expectations, provides real-world business solutions within your budget and on time, and while satisfying your end users.</p>
