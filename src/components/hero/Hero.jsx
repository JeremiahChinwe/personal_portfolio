...
export default function Hero() {
    return (
        <section className="flex flex-col justify-center items-center p-[1.25rem]" name="home">
            ...
            <p className="font-[400] text-center my-4 block sm:w-[80%] lg:w-[50%]">A front-end developer with passion for designing and developing visually appealing user interfaces that meet your business expectations while satisfying your end users.</p>
