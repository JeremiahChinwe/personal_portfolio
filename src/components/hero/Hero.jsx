...
export default function Hero() {
    return (
        <section className="flex flex-col justify-center items-center p-[1.25rem]" name="home">
            ...
            <p className="font-[400] text-center my-4 block sm:w-[80%] lg:w-[50%]">A greate business with an engaging user-facing interface will loose a great number of its potential customers.</p>
